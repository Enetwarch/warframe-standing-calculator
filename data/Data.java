...
public class Data {
    ...
    private static final Resource[] CONCLAVE_RESOURCE_RECORD = {}; // No resources for Conclave
    public static final Calculator conclave = new Calculator(CONCLAVE_SYNDICATE_NAME, CONCLAVE_RANK_RECORD, CONCLAVE_SACRIFICE_RECORD, CONCLAVE_RESOURCE_RECORD);
    ...
    public static final Calculator ostron = new Calculator(OSTRON_SYNDICATE_NAME, OSTRON_RANK_RECORD, OSTRON_SACRIFICE_RECORD, OSTRON_RESOURCE_RECORD);
    ...
    public static final Calculator theQuills = new Calculator(THE_QUILLS_SYNDICATE_NAME, THE_QUILLS_RANK_RECORD, THE_QUILLS_SACRIFICE_RECORD, THE_QUILLS_RESOURCE_RECORD);
    ...
    public static final Calculator solarisunited = new Calculator(SOLARIS_UNITED_SYNDICATE_NAME, SOLARIS_UNITED_RANK_RECORD, SOLARIS_UNITED_SACRIFICE_RECORD, SOLARIS_UNITED_RESOURCE_RECORD);
    ...
    public static final Calculator voxSolaris = new Calculator(VOX_SOLARIS_SYNDICATE_NAME, VOX_SOLARIS_RANK_RECORD, VOX_SOLARIS_SACRIFICE_RECORD, VOX_SOLARIS_RESOURCE_RECORD);
    ...
    private static final Sacrifice[] VENTKIDS_SACRIFICE_RECORD = {}; // No sacrifices for Ventkids
    private static final Resource[] VENTKIDS_RESOURCE_RECORD = {}; // No resources for Ventkids
    public static final Calculator ventkids = new Calculator(VENTKIDS_SYNDICATE_NAME, VENTKIDS_RANK_RECORD, VENTKIDS_SACRIFICE_RECORD, VENTKIDS_RESOURCE_RECORD);
    ...
    public static final Calculator entrati = new Calculator(ENTRATI_SYNDICATE_NAME, ENTRATI_RANK_RECORD, ENTRATI_SACRIFICE_RECORD, ENTRATI_RESOURCE_RECORD);
    ...
    public static final Calculator necraloid = new Calculator(NECRALOID_SYNDICATE_NAME, NECRALOID_RANK_RECORD, NECRALOID_SACRIFICE_RECORD, NECRALOID_RESOURCE_RECORD);
    ...
    public static final Calculator theHoldfasts = new Calculator(THE_HOLDFASTS_SYNDICATE_NAME, THE_HOLDFASTS_RANK_RECORD, THE_HOLDFASTS_SACRIFICE_RECORD, THE_HOLDFASTS_RESOURCE_RECORD);
    ...
    public static final Calculator cavia = new Calculator(CAVIA_SYNDICATE_NAME, CAVIA_RANK_RECORD, CAVIA_SACRIFICE_RECORD, CAVIA_RESOURCE_RECORD);
    ...
    public static final Calculator theHex = new Calculator(THE_HEX_SYNDICATE_NAME, THE_HEX_RANK_RECORD, THE_HEX_SACRIFICE_RECORD, THE_HEX_RESOURCE_RECORD);
