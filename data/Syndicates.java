...
public class Syndicates {
    ...
    public Standard conclave = new Standard(
        "Conclave",
        new String[]{
            "Neutral", 
            "Mistral", 
    ...
    public OneRank cephalonSimaris = new OneRank(
        "Cephalon Simaris",
        125000
    );
    ...
    public Standard ostron = new Standard(
        "Ostron",
        new String[]{
            "Neutral", 
            "Offworlder",
    ...
    public Standard theQuills = new Standard(
        "The Quills",
        new String[]{
            "Neutral", 
            "Mote", 
    ...
    public Standard solarisUnited = new Standard(
        "Solaris United",
        new String[]{
            "Neutral", 
            "Outworlder",
    ...
    public Standard voxSolaris = new Standard(
        "Vox Solaris",
        new String[]{
            "Neutral", 
            "Operative", 
    ...
    public Standard ventkids = new Standard(
        "Ventkids",
        new String[]{
            "Neutral", 
            "Operative", 
    ...
    public Standard entrati = new Standard(
        "Entrati",
        new String[]{
            "Neutral", 
            "Stranger", 
    ...
    public Standard necraloid = new Standard(
        "Necraloid",
        new String[]{
            "Neutral", 
            "Clearance: Agnesis",
    ...
    public Standard theHoldfasts = new Standard(
        "The Holdfasts",
        new String[]{
            "Neutral", 
            "Fallen",
    ...
    public Standard cavia = new Standard(
        "Cavia",
        new String[]{
            "Neutral", 
            "Assistant",
